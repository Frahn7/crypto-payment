...
function QrIcon() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g filter="url(#filter0_ddd_1511_39031)">
        <rect
          x="24"
          y="8.33334"
          width="193"
      ...
      <path
        d="M120.124 50.7238V61.6897H109.158V50.7238H120.124ZM109.158 115.149V130.775H120.124V115.149H109.158ZM142.056 174.639V163.673H131.09V152.707H120.124V174.639H142.056ZM163.988 93.2167H131.09V104.183H163.988V93.2167ZM163.988 115.149H179.34V104.183H163.988V115.149ZM163.988 130.775V141.741H190.306V115.149H179.34V130.775H163.988ZM131.09 34.275H120.124V50.7238H131.09V34.275ZM120.124 83.6216H131.09V61.6897H120.124V72.6556H109.158V104.183H120.124V83.6216ZM49.9424 93.2167V115.149H60.9083V104.183H77.3572V93.2167H49.9424ZM131.09 115.149V104.183H120.124V115.149H131.09ZM153.022 126.114H163.988V115.149H153.022V126.114ZM179.34 104.183H190.306V93.2167H179.34V104.183ZM142.056 115.149H131.09V130.775H120.124V141.741H142.056V115.149ZM109.158 152.707H120.124V141.741H109.158V152.707ZM142.056 141.741V152.707H163.988V141.741H142.056ZM174.954 163.673V152.707H163.988V163.673H174.954ZM190.306 174.639V163.673H174.954V174.639H190.306ZM153.022 174.639H163.988V163.673H153.022V174.639ZM99.289 104.183V93.2167H88.3231V104.183H77.3572V115.149H109.158V104.183H99.289ZM99.289 83.6216H49.9424V34.275H99.289V83.6216ZM88.3231 45.2409H60.9083V72.6556H88.3231V45.2409ZM80.0986 53.4653H69.1327V64.4312H80.0986V53.4653ZM190.306 34.275V83.6216H140.959V34.275H190.306ZM179.34 45.2409H151.925V72.6556H179.34V45.2409ZM171.116 53.4653H160.15V64.4312H171.116V53.4653ZM49.9424 125.292H99.289V174.639H49.9424V125.292ZM60.9083 163.673H88.3231V136.258H60.9083V163.673ZM69.1327 155.448H80.0986V144.482H69.1327V155.448Z"
        fill="black"
      />
      <defs>
        <filter
          id="filter0_ddd_1511_39031"
          x="0"
          y="0.333344"
          width="241"
          height="241"
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_1511_39031"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_1511_39031"
            result="effect2_dropShadow_1511_39031"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect2_dropShadow_1511_39031"
            result="effect3_dropShadow_1511_39031"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect3_dropShadow_1511_39031"
            result="shape"
          />
        </filter>
      </defs>
  ...
  return (
    <div className="w-full ml-[32px] ">
      ...
      <div className="mt-[35px] flex flex-col gap-[32px] justify-center items-center shadow-lg rounded-[16px]">
        ...
        <div className="flex flex-col gap-3 items-center mb-[32px] text-primary text-sm/5">
          <p className="flex flex-row items-center gap-2">
            Enviar <span className="font-bold">108,02 XRP</span> <CopyIcon />
          </p>
          <p className="flex flex-row items-center gap-2">
            {identifier} <CopyIcon />
          </p>
